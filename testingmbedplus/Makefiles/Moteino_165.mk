...
# Moteino AVR specifics
# ----------------------------------
#
PLATFORM         := Moteino
PLATFORM_TAG      = ARDUINO=10605 MOTEINO EMBEDXCODE=$(RELEASE_NOW) ARDUINO_ARCH_AVR
PLATFORM_VERSION := $(MOTEINO_AVR_RELEASE) for Arduino 1.6.5
...
BUILD_CORE       = avr
BOARDS_TXT      := $(MOTEINO_1)/hardware/avr/$(MOTEINO_AVR_RELEASE)/boards.txt
