...
#
#
# Last update: Feb 16, 2016 release 4.3.0


include $(MAKEFILE_PATH)/About.mk

# LinkIt Smart 7688 Duo AVR specifics
# ----------------------------------
#
PLATFORM         := LinkIt
PLATFORM_TAG      = ARDUINO=10605 LINKIT EMBEDXCODE=$(RELEASE_NOW) ARDUINO_ARCH_AVR ARDUINO_AVR_LINKITSMART7688
PLATFORM_VERSION := Duo $(LINKIT_DUO_RELEASE) for Arduino 1.6.5
...
BUILD_CORE       = avr
BOARDS_TXT      := $(LINKIT_AVR_1)/hardware/avr/$(LINKIT_DUO_RELEASE)/boards.txt
mdk1200          = $(call PARSE_BOARD,$(BOARD_TAG),build.core)
BUILD_CORE       = $(patsubst arduino:%,%,$(mdk1200))
...
mdk1300      = $(call PARSE_BOARD,$(BOARD_TAG),build.variant)
VARIANT      = $(patsubst arduino:%,%,$(mdk1300))
VARIANT_PATH = $(LINKIT_AVR_1)/hardware/avr/$(LINKIT_DUO_RELEASE)/variants/$(VARIANT)
